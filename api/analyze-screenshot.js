...
const COLOR_OPTIONS = ["黒髪", "暗髪ブラウン", "ブラウン", "ベージュ・ハイトーン", "アッシュ・グレー", "ピンク・レッド・オレンジ", "ブルー・パープル・グリーン", "ホワイト・ペール"];
...
必ず、以下の7系統のいずれかに分類できることを前提に判断すること（最低限カバーすべき分類）。
1. ブラック（黒髪）系 → 黒髪
2. ブラウン（茶髪）系 → 暗髪ブラウン／ブラウン
3. ベージュ・ハイトーン系 → ベージュ・ハイトーン
4. アッシュ・グレー・モノトーン系 → アッシュ・グレー
5. レッド・ピンク・オレンジ（暖色）系 → ピンク・レッド・オレンジ
6. ブルー・パープル・グリーン系 → ブルー・パープル・グリーン
7. ホワイト・ペール・特殊系 → ホワイト・ペール

- 黒髪：赤みや茶色みがほとんど感じられない、地毛に近い自然な黒〜濃い黒。光を当てても明るい色味がほぼ見えない。
- 暗髪ブラウン：一見黒に近いが、光の当たる部分に茶色みがうっすら見える暗めのブラウン。地毛よりわずかに明るい程度で、いわゆる「透明感のある暗髪」。
- ブラウン：赤み〜黄みのあるはっきりとしたライトブラウン〜ミディアムブラウン。暗髪ブラウンより明るく、ベージュ・ハイトーンほど抜けていない、いわゆる「茶髪」の主流域。
- ベージュ・ハイトーン：黄み・オレンジみを含んだ、明るめのベージュ〜ハイトーン域。日本人の地毛より明らかに明るく、抜け感のある柔らかい色味。
- アッシュ・グレー：赤み・黄みを抑えた、灰色がかった寒色系のカラー。外国人風の透明感・くすみ感がある、いわゆるモノトーン系。全体的に「グレーがかって見えるか」がポイント。
- ピンク・レッド・オレンジ：ピンク・レッド・オレンジなど、自然な髪色の範囲を超えた暖色系のはっきりした色味が乗っている。全体染めだけでなく、インナーカラーやメッシュなど部分的に目立って入っている場合も含む。
- ブルー・パープル・グリーン：ブルー・パープル・グリーンなど、自然な髪色の範囲を超えた寒色〜中間色のはっきりした色味が乗っている。全体染めだけでなく、インナーカラーやメッシュなど部分的に目立って入っている場合も含む。
- ホワイト・ペール：脱色による白髪風のホワイトや、極端に彩度を抑えたペールカラーなど、上記6分類のどれにも当てはまらない特殊カラー。
【判定のコツ】
1. まず、自然な髪色の範囲を超えたはっきりした色味（ピンク・レッド・オレンジ／ブルー・パープル・グリーン／ホワイト・ペール）が乗っていないかを最初に確認する。部分的なインナーカラー・メッシュでも目立って見えるなら、その色味を優先して選ぶこと。
2. 該当しない場合は、自然な髪色の範囲（黒髪／暗髪ブラウン／ブラウン／ベージュ・ハイトーン／アッシュ・グレー）の中で判断する。
3. まず「暗い（黒髪・暗髪ブラウンの候補）」か「明るい（ブラウン・ベージュ・ハイトーン・アッシュ・グレーの候補）」かを判断する。
4. 暗い場合：赤み・茶色みが全く無ければ「黒髪」、うっすら茶色みが見えれば「暗髪ブラウン」。
5. 明るい場合：グレー・くすみがかって寒色系に見えれば「アッシュ・グレー」、黄み・オレンジみのある暖色系でベージュほど明るくなければ「ブラウン」、それより明るく抜け感があれば「ベージュ・ハイトーン」。
6. 画像の照明・ホワイトバランスによる色かぶり（例：暖色照明で黒髪が茶色っぽく写る等）に惑わされず、髪全体のトーンで総合的に判断すること。
`.trim();
